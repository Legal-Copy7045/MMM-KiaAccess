...
// 1:1 copies. Every .py copy gets a "GENERATED, do not edit" banner
// prepended -- these files are otherwise byte-identical to their root
// counterpart (same docstring, same "kept line-for-line" comments), so
// there is nothing in the custom_components copy itself that distinguishes
// it from a hand-editable file. Edit the root/<name>.py instead and re-run
// this script.
const PY_BANNER =
  "# GENERATED by scripts/sync-core.js -- edit the root-level copy of this " +
  "file instead, then run `npm run sync`.\n";
for (const rel of [
  "core/entities.json",
  "core/commands.json",
  "kia_client.py",
  ...
  outputs[path.join(HA, path.basename(rel))] =
    rel.endsWith(".py") ? PY_BANNER + content : content;
}
